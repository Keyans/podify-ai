<template>
  ...
  <!-- 图库选择对话框 -->
  <GallerySelectDialog v-model="showGalleryDialog" theme-color="yellow" @select="handleGallerySelect" />
</template>
...
const handleGallerySelect = (images: any[]) => {
  const imagesWithId: SelectedImage[] = images.map(img => ({
