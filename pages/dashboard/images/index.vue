<template>
  <div>
    ...
    <div class="bg-white shadow-sm border-b mb-6">
      <div class="px-6 py-4">
        <h1 class="text-2xl font-semibold text-gray-900">图片管理</h1>
        <p class="text-gray-600 mt-1">管理和组织您的图片资源</p>
      </div>
    </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-gray-600">AI处理中</p>
        ...
        <div class="px-6 py-4">
          <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
            ...
            <div class="flex space-x-2">
              ...
              <div class="relative">
                <input type="text" placeholder="搜索图片..." class="border border-gray-300 rounded-md pl-10 pr-4 py-2">
      ...
      <div class="bg-white rounded-lg shadow">
        <div class="p-6">
          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            <!-- 图片项 -->
            <div v-for="i in 24" :key="i" class="group relative aspect-square bg-gray-100 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center space-x-2">
                ...
                <button class="bg-white text-red-600 p-2 rounded-full hover:bg-gray-100">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-2">
                <p class="text-white text-xs truncate">image_{{ i }}.jpg</p>
              </div>
            </div>
          </div>
        </div>
