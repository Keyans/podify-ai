      ...
      >
        <template #prefix>
          <div class="flex items-center space-x-4">
            <a-button @click="addOpen = true">新建标题</a-button>
          </div>
        </template>
      </PageSearch>
    </a-card>
...
// 导入 Composable
import { useList } from '~/composables/business/application/title/useList'
import { useDetailModal } from '~/composables/business/application/title/useDetailModal'
