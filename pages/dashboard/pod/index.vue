<template>
  <div>
    ...
    <div class="bg-white shadow-sm border-b mb-6">
      <div class="px-6 py-4">
        <h1 class="text-2xl font-semibold text-gray-900">POD管理</h1>
        <p class="text-gray-600 mt-1">按需打印产品管理和订单处理</p>
      </div>
    </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-gray-600">POD产品</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-semibold text-gray-900">¥15,680</p>
            </div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <button class="flex items-center justify-center p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
              <div class="text-center">
                ...
                <p class="text-sm font-medium text-gray-900">创建新产品</p>
              </div>
            </button>
            ...
            <button class="flex items-center justify-center p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-green-500 hover:bg-green-50 transition-colors">
              <div class="text-center">
                ...
                <p class="text-sm font-medium text-gray-900">批量上传</p>
              </div>
            </button>
            ...
            <button class="flex items-center justify-center p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-colors">
              <div class="text-center">
                ...
                <p class="text-sm font-medium text-gray-900">销售分析</p>
              </div>
            </button>
            ...
            <button class="flex items-center justify-center p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-orange-500 hover:bg-orange-50 transition-colors">
              <div class="text-center">
                ...
                <p class="text-sm font-medium text-gray-900">供应商管理</p>
              </div>
            </button>
          </div>
        </div>
      ...
      <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
          <div class="flex justify-between items-center">
            <h2 class="text-lg font-medium text-gray-900">POD产品列表</h2>
            <div class="flex space-x-2">
              ...
              <div class="relative">
                <input type="text" placeholder="搜索产品..." class="border border-gray-300 rounded-md pl-10 pr-4 py-2 text-sm">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="h-10 w-10 bg-gray-200 rounded-lg flex-shrink-0">
                      <div class="w-full h-full bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg"></div>
                    </div>
                    <div class="ml-4">
                      <div class="text-sm font-medium text-gray-900">创意T恤设计</div>
                      <div class="text-sm text-gray-500">SKU: POD001</div>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">T恤</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">¥89.00</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">已上架</span>
                </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  ...
                  <a href="#" class="text-green-600 hover:text-green-900 mr-3">复制</a>
...
useHead({
  title: 'POD管理 - PodifyAi',
  meta: [
    { name: 'description', content: 'PodifyAi POD管理页面' }
  ]
})
</script>